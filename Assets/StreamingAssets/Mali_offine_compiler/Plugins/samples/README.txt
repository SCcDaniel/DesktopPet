...
Copyright 2015-2021 Arm Ltd. All Rights Reserved.
...
created using the following glslangValidator command lines to compile the
...
We ship a pre-built version of glslangValidator. Full documentation and source
